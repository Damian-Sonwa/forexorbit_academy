        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-gradient-to-br from-[#E8F2FB] to-white rounded-2xl p-8 shadow-lg border-2 border-[#1E88E5]/20 hover:shadow-xl transition-all">
                <div className="w-16 h-16 bg-[#1E88E5] rounded-2xl flex items-center justify-center mb-6 overflow-hidden">
                  <img 
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-3">Structured Courses</h3>
              ...
              <div className="bg-gradient-to-br from-[#E3F6F4] to-white rounded-2xl p-8 shadow-lg border-2 border-[#00897B]/20 hover:shadow-xl transition-all">
                <div className="w-16 h-16 bg-[#00897B] rounded-2xl flex items-center justify-center mb-6 overflow-hidden">
                  <img 
              ...
              <div className="bg-gradient-to-br from-[#ECEFF9] to-white rounded-2xl p-8 shadow-lg border-2 border-[#283593]/20 hover:shadow-xl transition-all">
                <div className="w-16 h-16 bg-[#283593] rounded-2xl flex items-center justify-center mb-6 overflow-hidden">
                  <img 
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-3">Practical Lessons</h3>
                <p className="text-gray-700 leading-relaxed">
              ...
              <div className="bg-gradient-to-br from-[#E8F2FB] to-white rounded-2xl p-8 shadow-lg border-2 border-[#1E88E5]/20 hover:shadow-xl transition-all">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-3">Real-Time Analysis</h3>
                <p className="text-gray-700 leading-relaxed">
              ...
              <div className="bg-gradient-to-br from-[#E3F6F4] to-white rounded-2xl p-8 shadow-lg border-2 border-[#00897B]/20 hover:shadow-xl transition-all">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-3">Certification</h3>
                <p className="text-gray-700 leading-relaxed">
            ...
            {instructors.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {instructors.map((instructor: any, index: number) => {
                  ...
                  return (
                    <div key={instructor._id || instructor.id || index} className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200 hover:shadow-xl transition-all text-center">
                      {instructor.imageUrl ? (
                        <img
                      ...
                      >
                        <span className="text-5xl text-white">{instructor.name?.charAt(0) || '👨‍💼'}</span>
                      </div>
                      <h3 className="text-xl font-bold text-gray-900 mb-2">{instructor.name}</h3>
                      <p className="font-semibold mb-3" style={{ color: color.text }}>{instructor.title}</p>
                      <p className="text-gray-600 text-sm mb-4">{instructor.description}</p>
                      <button
                        onClick={() => {
                          // Handle consultation booking - you can add a modal or navigation here
                          alert(`Consultation with ${instructor.name} - Feature coming soon!`);
                        }}
                        className="w-full px-6 py-3 bg-primary-600 hover:bg-primary-700 text-white rounded-xl font-semibold transition-colors shadow-sm active:scale-95 touch-manipulation"
