...
export default function LessonSummaryView({ lesson }: LessonSummaryViewProps) {
  ...
  const hasVisualContent = (enrichedSummary?.keyPoints && enrichedSummary.keyPoints.length > 0) ||
    (enrichedSummary?.tradingNotes) ||
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Key Points */}
      {enrichedSummary?.keyPoints && enrichedSummary.keyPoints.length > 0 && (
