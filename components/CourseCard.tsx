...
export default function CourseCard({ course, onEnroll, onUnenroll }: CourseCardProps) {
  ...
  return (
    <div className="group bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100">
      {/* Course Thumbnail */}
      <div className="relative w-full h-48 bg-gradient-to-br from-primary-500 via-primary-600 to-secondary-600 overflow-hidden">
      ...
      <div className="p-6">
        ...
        <p className="text-gray-600 text-sm mb-4 line-clamp-3 min-h-[3.75rem]">{course.description}</p>
